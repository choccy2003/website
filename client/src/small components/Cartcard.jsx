    ...
    <div>
      <div className='cart-card'>
        <div style={{ display: "flex" }}>
          <div className='cart-img'><img src={props.best_array[props.cart_array.id].image[0]} style={{ height: "95px", width: "140px", marginTop: "4px", borderRadius: "5px", backgroundColor: "white" }}></img></div>
