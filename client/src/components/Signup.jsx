        ...
        <div style={{height:"100%",width:"100%",backgroundColor:"white",position:"absolute",zIndex:"9999",top:"0px",left:"0px"}}><div>
            ...
            <div style={{ height: '450px', width: '390px', backgroundColor: 'rgb(233, 233, 233)', borderRadius: '15px', margin: 'auto', marginTop: '70px', fontFamily: 'Arial, Helvetica, sans-serif' }}>
                ...
                <div style={{ fontSize: '28px', fontFamily: 'Arial, Helvetica, sans-serif', paddingTop: '30px', fontWeight: 600, width: 'auto', marginBottom: '30px' }}>
                    ...
                    <div style={{width:"fit-content",margin:"auto"}}>Create your account</div></div> 
                 <form>
                ...
                <div style={{ marginTop: '30px' }}>
                    <input style={{ width: '230px', marginLeft: '80px', borderRadius: '3px', height: '33px', backgroundColor: '#7ba550', border: 'none', color: 'white',fontSize:"16px" }} type="button" defaultValue="Create your account" />
                </div>
                </form>
                   
                
  
            </div><div style={{ width: 'fit-content', margin: 'auto', marginTop: '10px', fontWeight: 500 }}>Already have an account ? <a style={{ textDecoration: 'none' }} href="#"><Link to={'/login'}>Log in</Link></a></div>
